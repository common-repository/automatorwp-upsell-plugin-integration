...
class AutomatorWP_Upsell_Plugin_Purchase_Product extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a product', 'automatorwp-upsell-plugin-integration' ),
            'select_option'     => __( 'User purchases <strong>a product</strong>', 'automatorwp-upsell-plugin-integration' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases %1$s %2$s time(s)', 'automatorwp-upsell-plugin-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User purchases %1$s', 'automatorwp-upsell-plugin-integration' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Product:', 'automatorwp-upsell-plugin-integration' ),
                    'option_none_label' => __( 'any product', 'automatorwp-upsell-plugin-integration' ),
                    'post_type' => 'upsell_product'
                ) ),
                'times' => automatorwp_utilities_times_option(),
            ),
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Product', 'automatorwp-upsell-plugin-integration' ) ),
